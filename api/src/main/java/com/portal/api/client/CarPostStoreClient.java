...
public class CarPostStoreClient {
	...
	private static final String USER_STORE_SERVICE_URI = "http://localhost:8086/user";
	
	private static final String POSTS_STORE_SERVICE_URI = "http://localhost:8086/sales";
	
	@Autowired
	private RestTemplate restTemplate;
	
	public List<CarPostDTO> carForSalesClient() {
		ResponseEntity<CarPostDTO> responseEntity = restTemplate
				.getForEntity(USER_STORE_SERVICE_URI + "/cars", CarPostDTO.class);
